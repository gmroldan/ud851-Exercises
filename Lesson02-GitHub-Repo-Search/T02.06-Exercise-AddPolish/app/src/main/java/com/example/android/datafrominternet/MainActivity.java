...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.errorMessageTextView = (TextView) findViewById(R.id.tv_error_message_display);
    ...
    private void showJsonDataView() {
        ...
        this.mSearchResultsTextView.setVisibility(View.VISIBLE);
    }

    // TODO (15) Create a method called showErrorMessage to show the error and hide the data - done!!!
    private void showErrorMessage() {
        this.mSearchResultsTextView.setVisibility(View.INVISIBLE);
